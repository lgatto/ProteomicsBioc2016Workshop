...
* Identification tranfer between acquisitions (label-free): if a
  ...
  coordinates of the same ion in a replicate where it was identified.
...
* Different imputation methods are more appropriate to different
  ...
  with different methods: left-censored methods are adequate for the
  latter, while hot deck methods should be used for the former.

# Major differences with RNASeq

- missing values (see above)
- coverage
- protein inference
- identifier mapping
