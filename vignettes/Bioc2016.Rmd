...
## (5) Indeces of the 1st and 2d MS1 spectra after 30 minutes
i <- ms1[which(rtsel)][1]
j <- ms1[which(rtsel)][2]
...
* Isobaric tagging (iTRAQ and TMT): `r Biocpkg("MSnbase")` 
  and `r Biocpkg("isboar")` for statistical analysis.  
* Label-free: `r Biocpkg("xcms")` (metabolomics), `r CRANpkg("aLFQ")`
  and `r CRANpkg("protiq")` for statistical analysis.
* Counting: `r Biocpkg("MSnbase")`, `r Biocpkg("MSnID")` for
  peptide-spectrum matching confidence assessment and 
  `r Biocpkg("msmsTests")` for statistical analysis.
