...
Identification tranfer between acquisitions (label-free): if a feautre
was not acquired in MS2 in one replicte, it is possible to find the
...
however not a straighforward thing, as is likely to dramatically fail
...
agains the UniProt webservices. (See `?upens` for details.)
